...
class LineDetectorHSV:
    def __init__(self):
        ...
        self.hsv_white1 = 0
        self.hsv_white2 = 0.17
        self.hsv_yellow1 = 0
        self.hsv_yellow2 = 360
        self.hsv_red1 = 0
        self.hsv_red2 = 22
        self.hsv_red3 = 340
        self.hsv_red4 = 360
        self.dilation_kernel_size = 100
        self.canny_thresholds = [60, 140]
        self.hough_threshold = 150
        self.hough_min_line_length = 0
        self.hough_max_line_gap = 0

    # def _init_values(*input):
    #     ...
    ...
    def detectLines(self, color):
        ...
        return [lines, normals, bw, centers]
