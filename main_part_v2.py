...
# Модули наших рук
from moments import get_action
...
from detector_by_bgr import detector_by_bgr
from new_d import dijkstra_file as alg_d
from line_detector_v2 import detector
...
def update(dt):
    ...
    if env.unwrapped.step_count % 5 == 1:
        ...
        #жёлтый
        im = detector_by_bgr(im, [20, 100, 100], [150, 250, 250], True, [150, 100, 250])
        #красный
